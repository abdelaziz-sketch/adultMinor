...
export default function LicensingForm() {
  const [flowType, setFlowType] = useState<"adult" | "minor">("adult")
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border p-6 space-y-6">
          ...
          <div>
            ...
            <div className="space-y-4 mb-4">
              <div className="flex items-start space-x-3">
                ...
                >
                  I have read and fully agree to the{" "}
                  <span className="text-blue-600 hover:text-blue-800 underline">Exclusive License Agreement</span> on
        ...
        <DialogContent className="max-w-4xl max-h-[90vh] flex flex-col">
          ...
          <div className="flex-1 relative">
            <div
              ...
              className="h-96 overflow-y-auto pr-4 text-sm text-gray-700 leading-relaxed"
            >
              {flowType === "adult" ? (
                <div className="space-y-4">
                  <h3 className="font-bold text-base">Exclusive License Agreement</h3>
                  <p>
                  ...
                  <p className="ml-4">
                    i. manage, use, refrain from using, or alter the Licensed Material by any and all methods or means;
                  </p>
                  <p className="ml-4">
                    ii. allow others, by any and all methods or means, to exploit the Licensed Material by any and all
                    methods or means, whether now known or hereafter devised, including without limitation in Media and
                    throughout Distribution Channels, by itself, its successors or assigns, for any purpose whatsoever
                    as Licensee in its sole discretion may determine;
                  </p>
                  <p className="ml-4">
                    iii. re-produce, distribute, modify, edit, adapt, publish, translate, incorporate, prepare
                    derivative or collective works utilizing, display, and perform any portion of the Licensed Material
                    including, but not limited to, in connection with the training or tuning of, ingestion into,
                    analysis by, or any other manipulation of or use by, any machine-learning based assembly,
                    ...
                    otherwise)), in each case for any purpose.
                  </p>
                  ...
                  <p className="ml-4">
                    ii. enforce all claims and prosecute actions against any and all claims from the past, present, and
                    future use of the Licensed Material by unauthorized third parties; and
                  </p>
                  <p className="ml-4">
                  ...
                  <p className="ml-4">
                    ...
                    Fifty Percent (50%) of the fee obtained by Licensee for such use ("Third Party Fee"). The fee shall
                    be paid to Licensor within thirty (30) days of Licensee's receipt of such fee.
                  </p>
                </div>
              ) : (
                <div className="space-y-4">
                  <h3 className="font-bold text-base">Exclusive License Agreement for Minors</h3>
                  <p>
            ...
            {showScrollIndicator && (
              <div
                className="absolute bottom-4 left-1/2 transform -translate-x-1/2 bg-[#d8e6fd] px-3 py-2 rounded-lg cursor-pointer flex items-center gap-2 text-sm z-10"
                onClick={scrollToBottom}
              >
                <span className="text-gray-600">▼</span>
                <span className="whitespace-nowrap">Scroll down to read full agreement</span>
              </div>
            )}
          </div>
      ...
      <Button onClick={handleSubmit} className="bg-blue-600 hover:bg-blue-700 text-white w-full mt-6">
        Submit
      </Button>
    </div>
  )
